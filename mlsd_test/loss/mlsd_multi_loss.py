...
#sys.path.append('/home/lifan/pangyu/code/Total')
from ._func import focal_neg_loss_with_logits#, weighted_bce_with_logits
#from mlsd_segmentation.utils.decode import deccode_lines_TP
...
class LineSegmentLoss(nn.Module):
    ...
    def forward(self, preds, gts,tp_gt_lines_512_list,sol_gt_lines_512_list):
        ...
        line_seg_loss= self.line_and_juc_seg_loss(preds, gts)

        loss_dict = {'line_seg_loss': line_seg_loss,}
